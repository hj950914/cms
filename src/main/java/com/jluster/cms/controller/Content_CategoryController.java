...
public class Content_CategoryController {
    ...
    @PostMapping(value = "/ContentCategory", consumes = APPLICATION_JSON_UTF8_VALUE)
    ...
    @DeleteMapping("/ContentCategory/{id}")
    ...
    @PutMapping(value = "/ContentCategory/{id}", consumes = APPLICATION_JSON_UTF8_VALUE)
